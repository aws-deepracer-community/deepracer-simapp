...
from deepracer_env.cameras.constants import GazeboWorld
from deepracer_env.cameras.utils import normalize, project_to_2d, ray_plane_intersect
from deepracer_env.constants import SIMAPP_VERSION_3
...
class Frustum(object):
    def __init__(self, agent_name, observation_list, version):
        ...
        if version >= SIMAPP_VERSION_3:
            # camera offset is calculcated in homogeneous coordinates according to v3 physics
