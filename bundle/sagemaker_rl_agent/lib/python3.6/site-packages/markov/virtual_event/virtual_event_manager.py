...
class VirtualEventManager(object):
    ...
    def __init__(self, queue_url, aws_region='us-east-1',
        ...
        self._racecar_model = AgentModel(name=self._current_car_model_state.model_name)
    ...
    def setup_race(self):
        ...
        try:
            ...
            if self._last_body_shell_type != body_shell_type or \
                ...
                self._racecar_model.spawn(pose=hide_pose,
                                          include_second_camera="true" if Input.STEREO.value in sensors else "false",
                                          include_lidar_sensor="true" if Input.LIDAR.value in sensors else "false",
                                          body_shell_type=body_shell_type,
                                          lidar_360_degree_sample=LIDAR_360_DEGREE_SAMPLE,
                                          lidar_360_degree_horizontal_resolution=LIDAR_360_DEGREE_HORIZONTAL_RESOLUTION,
                                          lidar_360_degree_min_angle=LIDAR_360_DEGREE_MIN_ANGLE,
                                          lidar_360_degree_max_angle=LIDAR_360_DEGREE_MAX_ANGLE,
                                          lidar_360_degree_min_range=LIDAR_360_DEGREE_MIN_RANGE,
                                          lidar_360_degree_max_range=LIDAR_360_DEGREE_MAX_RANGE,
                                          lidar_360_degree_range_resolution=LIDAR_360_DEGREE_RANGE_RESOLUTION,
                                          lidar_360_degree_noise_mean=LIDAR_360_DEGREE_NOISE_MEAN,
                                          lidar_360_degree_noise_stddev=LIDAR_360_DEGREE_NOISE_STDDEV)
            ...
            if const.F1 in body_shell_type:
                self._model_updater.hide_visuals(
                    visuals=visuals,
                    ignore_keywords=["f1_body_link"] if "amazon_van" in body_shell_type.lower()
