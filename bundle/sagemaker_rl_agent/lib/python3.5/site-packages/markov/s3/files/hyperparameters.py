...
class Hyperparameters():
    ...
    def persist(self, hyperparams_json, s3_kms_extra_args):
        ...
        LOG.info("[s3] Successfully upload hyperparameters to \
    ...
    def _download(self):
        ...
        try:
            ...
            # TODO: should this be 500 instead of using default value
            # for hyperparameter, if not found "404" or other client error,
            # use default hyperparameter in sagemaker_graph_manager.py and return
            self._hyperparameters = {}
            LOG.info("SageMaker hyperparameters not found.")
            return
