...
class YamlFile():
    ...
    def _download(self):
        ...
        # download with retry
        # TODO: Current botocore.exceptions.ClientError is caught in
        # download_params_and_roslaunch_agent.py and tournament_node.py
        # so we keep the logic for now to throw exception like before.
        # will discuss with team for further action
