...
class RewardFunction():
    ...
    def _download(self):
        ...
        try:
            ...
            # TODO: should all error code be 500 or only 404 should be 500
            # for reward function "404" is system fault because it is unlikely user is
            # going to delete their reward function in s3
            if err.response['Error']['Code'] == "404":
                error_code = SIMAPP_EVENT_ERROR_CODE_500
            else:
                error_code = SIMAPP_EVENT_ERROR_CODE_400
            log_and_exit("Unable to download file (s3bucket: {} s3_key: {} \
                code: {} message: {})".format(self._bucket,
                                              self._s3_key,
