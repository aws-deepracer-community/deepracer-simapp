...
class ModelMetadata():
    ...
    def _download(self):
        ...
        #TODO: Keep the old logic to throw error back to each worker and let it handle
        # 400 or 500. However, SimApp team need to discuss on better error handling
        ...
        # validate downloaded model metadata
        ...
        try:
            with open(self._local_path, 'r') as f:
                ...
                if 'action_space' not in model_metadata:
                    raise Exception("no action space defined")
        except Exception as e:
            log_and_exit("Failed to parse model_metadata file: {}".format(e),
                         SIMAPP_SIMULATION_WORKER_EXCEPTION,
                         SIMAPP_EVENT_ERROR_CODE_500)
