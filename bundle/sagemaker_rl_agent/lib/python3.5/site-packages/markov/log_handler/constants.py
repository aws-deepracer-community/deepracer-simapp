...
FAULT_MAP = {
    1: "Invalid arguments for client",
    ...
    31: "Can't download best checkpoint",
    32: "No objects found",
    ...
    40: "Exception thrown in logger - log_and_exit",
    ...
    52: "Download params and launch of agent node failed: s3_bucket:",
