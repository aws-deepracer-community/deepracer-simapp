...
# Skip integration tests - these are long-running tests that train full RL models for 1+ hours
# They should be run separately from unit tests in dedicated integration test pipelines
pytest.skip("Integration tests should not be run as unit tests. Use dedicated integration test pipeline.", allow_module_level=True)
