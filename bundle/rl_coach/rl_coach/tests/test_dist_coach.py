...
# Skip distributed coach tests - these are integration tests that require cloud infrastructure
# They should be run separately from unit tests in dedicated integration test pipelines
pytest.skip("Distributed coach tests should not be run as unit tests. Use dedicated integration test pipeline.", allow_module_level=True)
