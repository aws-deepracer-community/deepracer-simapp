...
# Skip functional tests - these are long-running tests that execute full training sessions
# They should be run separately from unit tests in dedicated integration test pipelines
pytest.skip("Functional tests should not be run as unit tests. Use dedicated integration test pipeline.", allow_module_level=True)
import subprocess
import time
import pytest
