...
"""
Launch file for virtual event single agent WebRTC streaming.
"""
...
def generate_launch_description():
    ...
    config_file = os.path.join(pkg_dir, 'config', 'deepracer_single_agent_webrtc_config.yaml')
    ...
    racecar_name_arg = DeclareLaunchArgument(
        'racecar_name',
        description='Name of the racecar'
    )
    
    signaling_channel_name_arg = DeclareLaunchArgument(
        'signaling_channel_name',
        description='Name of the signaling channel'
    )
    ...
    node = Node(
        ...
        parameters=[
            config_file,
            {
                ...
                'webrtc_streamer_configuration.stream0.signaling_channel_name': LaunchConfiguration('signaling_channel_name'),
            }
        ]
    )
