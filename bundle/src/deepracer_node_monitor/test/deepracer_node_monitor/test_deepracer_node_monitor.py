...
class DeepRacerNodeMonitorTest(TestCase):
    ...
    @patch(
        "deepracer_node_monitor.deepracer_node_monitor.S3Utils.get_s3_heartbeat_location_path"
    )
    @patch(
        "deepracer_node_monitor.deepracer_node_monitor.CloudWatchJobStatusMetricDimensionData.is_cloudwatch_heartbeat_enabled"
    )
    def test_initialize(
        self,
        is_cloudwatch_heartbeat_enabled,
        get_s3_heartbeat_location_path,
        Boto3Factory_mock,
        rlock_mock,
    ):
    ...
    @patch(
        "deepracer_node_monitor.deepracer_node_monitor.S3Utils.get_s3_heartbeat_file_content"
    )
    @patch(
        "deepracer_node_monitor.deepracer_node_monitor.S3Utils.get_heartbeat_s3_info"
    )
    def test_upload_s3_job_status(
        self,
        get_heartbeat_s3_info_mock,
        get_s3_heartbeat_file_content_mock,
        Boto3Factory_mock,
        rlock_mock,
    ):
        ...
        Boto3Factory_mock.create_boto3_client.assert_has_calls([call(Boto3Client.S3)])
        Boto3Factory_mock.create_boto3_client(
            Boto3Client.S3
        ).put_object.assert_called_once_with(
            Bucket="s3_bucket",
            Key="s3_prefix",
            Body=bytes(str("test_json"), encoding="utf-8"),
        )
    ...
    def test_upload_s3_job_status_empty_s3_bucket(
        self,
        get_heartbeat_s3_info_mock,
        get_s3_heartbeat_file_content_mock,
        Boto3Factory_mock,
    ...
    def test_upload_s3_job_status_empty_s3_key(
        self,
        get_heartbeat_s3_info_mock,
        get_s3_heartbeat_file_content_mock,
        Boto3Factory_mock,
    ...
    def test_upload_s3_job_status_empty_s3_bucket_key(
        self,
        get_heartbeat_s3_info_mock,
        get_s3_heartbeat_file_content_mock,
        Boto3Factory_mock,
    ...
    @patch(
        "deepracer_node_monitor.deepracer_node_monitor.CloudWatchJobStatusMetricDimensionData"
    )
    def test_write_cw_metrics(
        self,
        CloudWatchJobStatusMetricDimensionData_mock,
        get_job_id_mock,
        Boto3Factory_mock,
        rlock_mock,
    ):
        ...
        Boto3Factory_mock.create_boto3_client = MagicMock()
        Boto3Factory_mock.create_boto3_client(
            Boto3Client.CLOUDWATCH
        ).put_metric_data = MagicMock()
        ...
        Boto3Factory_mock.create_boto3_client(
            Boto3Client.CLOUDWATCH
        ).put_metric_data.assert_has_calls(
            [
                call(
                    Namespace=CW_METRIC_NAMESPACE,
                    MetricData=[{"cw_metric_data_jobstatus": "hi"}],
                ),
                call(
                    Namespace=CW_METRIC_NAMESPACE,
                    MetricData=[
    ...
    def test_write_cw_metrics_empty_simapp_id(
        self,
        CloudWatchJobStatusMetricDimensionData_mock,
        get_job_id_mock,
        Boto3Factory_mock,
    ...
    def test_write_cw_metrics_empty_all(
        self,
        CloudWatchJobStatusMetricDimensionData_mock,
        get_job_id_mock,
        Boto3Factory_mock,
        ...
        Boto3Factory_mock.create_boto3_client(
            Boto3Client.CLOUDWATCH
        ).put_metric_data.assert_not_called()

    @patch("deepracer_node_monitor.deepracer_node_monitor.JobUtils.get_job_id")
    @patch(
        "deepracer_node_monitor.deepracer_node_monitor.CloudWatchJobStatusMetricDimensionData"
    )
    def test_write_cw_metrics_heartbeat_disabled(
        self,
        CloudWatchJobStatusMetricDimensionData_mock,
        get_job_id_mock,
        Boto3Factory_mock,
    ...
    def test_on_dead_node_update(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        deepracer_node_monitor._upload_s3_job_status = MagicMock()
        deepracer_node_monitor._write_cw_metrics = MagicMock()
        deepracer_node_monitor.on_dead_node_update(
            node_monitor_mock, set({"dead_node"})
        )
        ...
        deepracer_node_monitor._write_cw_metrics.assert_called_once_with(
            JobStatus.FAILED
        )

    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_on_dead_node_update_dead_node_previously_detected(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        deepracer_node_monitor._upload_s3_job_status = MagicMock()
    ...
    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_on_running_node_update_all_nodes_running(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        deepracer_node_monitor._upload_s3_job_status = MagicMock()
    ...
    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_on_running_node_update_all_nodes_running_with_extra(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        deepracer_node_monitor._upload_s3_job_status = MagicMock()
    ...
    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_on_running_node_update_all_nodes_not_running(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        deepracer_node_monitor._upload_s3_job_status = MagicMock()
        deepracer_node_monitor._write_cw_metrics = MagicMock()
        deepracer_node_monitor.on_running_node_update(
            node_monitor_mock, set({"/gazebo"})
        )
        deepracer_node_monitor._upload_s3_job_status.assert_not_called()
        deepracer_node_monitor._write_cw_metrics.assert_not_called()

    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_on_start(self, node_monitor_mock, Boto3Factory_mock, rlock_mock):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        deepracer_node_monitor._upload_s3_job_status = MagicMock()
        deepracer_node_monitor._write_cw_metrics = MagicMock()
    ...
    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_check_all_monitor_nodes_running(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
    ...
    @patch("deepracer_node_monitor.deepracer_node_monitor.NodeMonitor")
    def test_check_all_monitor_nodes_running_false(
        self, node_monitor_mock, Boto3Factory_mock, rlock_mock
    ):
        deepracer_node_monitor = DeepRacerNodeMonitor(monitor_nodes=self.monitor_nodes)
        return_val = deepracer_node_monitor._check_all_monitor_nodes_running(
