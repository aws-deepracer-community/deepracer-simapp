...
def generate_launch_description():
    """
    Launch description for distributed_training
    """
    ...
    return LaunchDescription([
        ExecuteProcess(
            cmd=[
                ...
                EnvironmentVariable('SAGEMAKER_SHARED_S3_BUCKET'),
                EnvironmentVariable('SAGEMAKER_SHARED_S3_PREFIX'),
                EnvironmentVariable('S3_YAML_NAME'),
                'rollout_rl_agent.launch.py'
            ],
