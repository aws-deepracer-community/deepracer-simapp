...
'''This module implements firehose client for metrics'''
...
class FirehoseMetrics:
    ...
    def __init__(self, delivery_stream_name, s3_bucket, s3_prefix, 
        ...
        if not delivery_stream_name:
            log_and_exit("Firehose metrics delivery stream name not available.",
    ...
    def persist_buffered_records(self): 
        ...
        LOG.info("[firehose] Successfully uploaded metrics to \
    ...
    def delete(self):
        '''Delete metric objects from S3 bucket'''
        # delete metrics
