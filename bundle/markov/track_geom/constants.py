...
GET_LINK_STATE = '/deepracer/get_link_state'
GET_MODEL_STATE = '/deepracer/get_model_state'
SET_MODEL_STATE = '/deepracer/set_model_state'
GET_LINK_STATES = '/deepracer/get_link_states'
GET_MODEL_STATES = '/deepracer/get_model_states'
SET_MODEL_STATES = '/deepracer/set_model_states'
SPAWN_URDF_MODEL = '/deepracer/spawn_urdf_model'
SPAWN_SDF_MODEL = '/deepracer/spawn_sdf_model'
DELETE_MODEL = '/deepracer/delete_model'
