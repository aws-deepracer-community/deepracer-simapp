...
# source python hooks
for exe, args in [('share/aws_robomaker_simulation_ros_pkgs/hook/ros_package_path.py', []), ('share/aws_robomaker_simulation_ros_pkgs/hook/pkg_config_path.py', []), ('share/aws_robomaker_simulation_ros_pkgs/hook/pkg_config_path_multiarch.py', [])]:
