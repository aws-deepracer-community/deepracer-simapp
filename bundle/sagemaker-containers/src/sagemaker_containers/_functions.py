...
def getargspec(fn):  # type: (function) -> inspect.FullArgSpec
    ...
    Returns:
        `inspect.FullArgSpec`:  A collections.namedtuple with the following attributes:

            * Args:
                args (list): a list of the argument names (it may contain nested lists).
                varargs (str): name of the * argument or None.
                varkw (str): names of the ** argument or None.
                defaults (tuple): an n-tuple of the default values of the last n arguments.
                kwonlyargs (list): A list of keyword-only parameter names.
                kwonlydefaults (dict): A dict mapping parameter names from kwonlyargs to the default values.
                annotations (dict): A dict mapping parameter names to annotations.
    """
