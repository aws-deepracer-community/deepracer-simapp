...
def request(path='/', base_url=None, query_string=None, accept=None, method='GET', input_stream=None,
            content_type=None, content_length=None, headers=None, data=None, mimetype=None):
    ...
    environ_builder = werkzeug_test.EnvironBuilder(
        ...
        content_type=content_type, content_length=content_length, headers=headers, data=data,
        mimetype=mimetype)
