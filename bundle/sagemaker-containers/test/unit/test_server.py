...
@patch('sagemaker_containers._server.files', lambda x: type('MockPath', (), {'__truediv__': lambda self, other: type('MockPath', (), {'__truediv__': lambda self, other: '/tmp/nginx.conf'})()})())
@patch('sagemaker_containers._env.num_gpus', lambda: 0)
@patch('sys.exit', lambda x: 0)
@patch('subprocess.Popen')
