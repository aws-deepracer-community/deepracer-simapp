...
@pytest.mark.parametrize('fn, expected', [
    (lambda: None, inspect.FullArgSpec([], None, None, None, [], None, {})),
    (lambda x, y='y': None, inspect.FullArgSpec(['x', 'y'], None, None, ('y',), [], None, {})),
    (lambda *args: None, inspect.FullArgSpec([], 'args', None, None, [], None, {})),
    (lambda **kwargs: None, inspect.FullArgSpec([], None, 'kwargs', None, [], None, {})),
    (lambda x, y, *args, **kwargs: None, inspect.FullArgSpec(['x', 'y'], 'args', 'kwargs', None, [], None, {}))
])
