...
class SetVisualPoseRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetVisualPoseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetVisualPoseRequest
    let len;
    let data = new SetVisualPoseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetVisualPoseRequest(null);
...
class SetVisualPoseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetVisualPoseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetVisualPoseResponse
    let len;
    let data = new SetVisualPoseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'deepracer_msgs/SetVisualPoseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetVisualPoseResponse(null);
...
module.exports = {
  Request: SetVisualPoseRequest,
  Response: SetVisualPoseResponse,
  md5sum() { return '3b6fe41d1c80e9b62f81f01d6ed4fc64'; },
  datatype() { return 'deepracer_msgs/SetVisualPose'; }
};
