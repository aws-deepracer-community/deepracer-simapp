...
bool operator==(const ::deepracer_msgs::SetVisualVisibleResponse_<ContainerAllocator1> & lhs, const ::deepracer_msgs::SetVisualVisibleResponse_<ContainerAllocator2> & rhs)
{
