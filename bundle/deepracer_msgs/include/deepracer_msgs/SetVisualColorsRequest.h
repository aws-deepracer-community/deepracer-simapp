...
bool operator==(const ::deepracer_msgs::SetVisualColorsRequest_<ContainerAllocator1> & lhs, const ::deepracer_msgs::SetVisualColorsRequest_<ContainerAllocator2> & rhs)
{
