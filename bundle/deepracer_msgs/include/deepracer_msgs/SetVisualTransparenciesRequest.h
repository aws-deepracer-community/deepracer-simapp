...
bool operator==(const ::deepracer_msgs::SetVisualTransparenciesRequest_<ContainerAllocator1> & lhs, const ::deepracer_msgs::SetVisualTransparenciesRequest_<ContainerAllocator2> & rhs)
{
